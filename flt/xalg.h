...
/*   Updated: 2019/03/03 19:52:24 by mstygg           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
** utility_functions.c
*/
t_x						*find_column_object_by_name(t_x *root,
						unsigned char *name);
...
unsigned char			get_figure_name_by_point(t_list *solution,
						unsigned char *point);
...
void					print_structure_columns(int *i, int *a,
						t_x *dn, t_x *arr[]);
...
*/
void					prepare_line(unsigned char *dst, unsigned char *src,
						int shift_margin, int m_s);
int						get_shift_margin(unsigned char *str);
int						get_figure(int fd, unsigned char *line,
						int prev_length, int m_s);
int						process_file(char *file_name, t_x *root,
						unsigned char ***cols, int m_s);
/*
...
int						create_column_objects(t_x *root,
						unsigned char ***cols);
t_x						*append_figure_type_column(t_x *root,
						unsigned char *figure);
int						insert_figure(t_x *root, t_x *row, unsigned char *line,
						unsigned char ***cols);
int						create_matrix_row(t_x *root, unsigned char *fig,
						unsigned char *line, unsigned char ***cs);
/*
